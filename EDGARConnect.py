...
class EDGARConnect:
                    ...
                    for iterrow_tuple in rows_to_query.iterrows():
                        ...
                        while attempts < 2:
                            try:
                                ...
                                filing = self.http.get(
                                    target_url, headers=self.header, timeout=timeout
                                )
    ...
    def _update_user_agent(self, force_update=True):
        time_to_update = (
    ...
    def _time_check(self, ignore_time_guidelines=False):
        ...
        if not SEC_servers_open and not ignore_time_guidelines:
            print(
                """SEC guidelines request batch downloads be done between 9PM and 6AM EST. If you plan to download
